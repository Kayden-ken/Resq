...
|--------------------------------------------------------------------------
|
| Web routes for admin dashboard and web interface
|
*/
...
Route::prefix('admin')->middleware('admin.auth')->group(function () {
    ...
    Route::get('/settings/emergency-types', [SettingController::class, 'emergencyTypes'])->name('admin.settings.emergency-types');
    Route::post('/settings/emergency-types', [SettingController::class, 'storeEmergencyType'])->name('admin.settings.emergency-types.store');
    Route::put('/settings/emergency-types/{id}', [SettingController::class, 'updateEmergencyType'])->name('admin.settings.emergency-types.update');
    Route::delete('/settings/emergency-types/{id}', [SettingController::class, 'deleteEmergencyType'])->name('admin.settings.emergency-types.delete');
